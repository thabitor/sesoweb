...
import TeamTechnical from '../TeamTechnical';
...
function OurTeam() {
    ...
    return(
        <Fragment>
            <PageTitle pageTitle={t('main.header.navItems.OurTeam')} pageTitlebg={'bg-about'} pagesub={'About'}/>
            ...
            <TeamREAB subclass={'white-bg'} />
            <TeamTechnical subclass={'grey-bg'} />
            <Footer/>
            <Scrollbar/>
        </Fragment>
    )
